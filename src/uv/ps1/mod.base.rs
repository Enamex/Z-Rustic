                    ...
                    let response =
                        ...
                        <html><head><title>Hello, Rust!</title>
                            <style>body { background-color: #111; color: #FFEEAA }
                                h1 { font-size:2cm; text-align: center; color: white; text-shadow: 0 0 4mm red }
                                h2 { font-size:2cm; text-align: center; color: white; text-shadow: 0 0 4mm green }</style>
                        </head>
                        <body><h1>Greetings, Krusty!</h1></body></html>";
